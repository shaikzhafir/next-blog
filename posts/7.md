...
### Solution
Just follow what my extremely helpful senior colleague taught
...
<img src="/images/gitmerge.png" alt="gitmerge" height=100% width=100%>
...
<img src="/images/gitrebase.png" alt="gitrebase" height=100% width=100%>
...
##### DISCLAIMER If there are any mistakes or gaps in logic or if this is just plain wrong then pray that I achieve enlightenment and update this post